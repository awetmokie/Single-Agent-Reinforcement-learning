...
if __name__ == '__main__':
    ...
    input_dims = env.observation_space.shape[1]*env.observation_space.shape[0]*env.observation_space.shape[2]
    ...
    # agent.load_model(  path="state_dict_model_v2.pt")
    ...
    for i in range(n_games):
        ...
        while not done:
            ...
            samples.append((observation.reshape(input_dims), _,int(info['cost']), reward, observation_.reshape(input_dims),done))
