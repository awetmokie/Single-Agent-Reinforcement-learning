...
from CC_Reinforce_version_3_copy.reinforce_torch import PolicyGradientAgent as CC_Reinforce_3_PolicyGradientAgent
...
# })  
    ...
    if not EVALUATE:
        ...
        agent.load_model(  path="CC_Reinforce_version_3_copy/tmp/highway/state_dict_model" +  str(0.05) +".pt")
        scores = []
        eval_games = 500
        counter = 0 
        time_step = 0
