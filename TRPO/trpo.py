...
def test(epochs=500, num_rollouts=20, render_frequency=None):
    scores =[]
    counter = 0
    load_model(path="state_dict_model_trpo.pt")
...
# Train our agent
# train(epochs=500, num_rollouts=10, render_frequency=50)

# save_model(actor,path= "state_dict_model_trpo.pt")
