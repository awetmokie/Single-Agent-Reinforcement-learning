    ...
    if not EVALUATE:
        for i in range(n_games):
            ...
            while not done:
                ...
                agent.store_costs(5*float(info['agents_costs'][0]))
        ...
        agent.save_model(  path="state_dict_model_v3.pt")
    
    else:
        agent.load_model(path ="state_dict_model_v3.pt")
        ...
        print('the probability of constraint violation is :',counter/eval_games)
